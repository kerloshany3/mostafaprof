...
const About = () => {
    const about = [
        ...
        { name: "Email", icon: <MdEmail />, details: "mostafawazzany@gmail.com" },
        ...
        <div className="m-10 md:m-20">
            <div className="grid grid-cols-1 lg:grid-cols-6 gap-8">
                ...
                <div className="col-span-1 lg:col-span-4">
                    <div className="p-6  shadow-white/20 shadow-2xl  bg-white rounded-tr-[80px] rounded-bl-[80px] ">
                                    ...
                                    {about.map((item, index) => (
                                        <div className="font-bold hover:scale-105 transition p-5 bg-white rounded-md shadow-md" key={index}>
                                            <div className="flex gap-4 items-center">
                                                ...
                                                <div>
                                                    <h4 className="text-xl sm:text-2xl text-primary2">{item.name}:</h4>
                                                    <h4 className="text-xl sm:text-xl text-primary2">{item.details}</h4>
                                                </div>
                                            </div>
                                        </div>
                                    ))}
